...
| CX-004 | resolved-scoped | Borderless/light cards vs readability — RULE-CARD-SURFACE-001 CORE with hard P0 contrast/affordance override (not “always borderless”). |
