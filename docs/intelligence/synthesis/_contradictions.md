...
| ID | Status | Topic |
| --- | --- | --- |
| CX-002 | open | Carbon disabled contrast policy (“not subject to WCAG contrast”) vs strict reading of non-text contrast — capture Carbon a11y page before elevating CB-C5 |
| CX-003 | open-documented | Floating labels (VID-SAMPLE-004 / Revolut tip) vs persistent-label a11y consensus. **Working resolution:** default to PRINCIPLE-FORM-LABEL-001 (persistent); floating labels EXPERIMENTAL only. |
...
| CX-005 | noted | “When do you draw a line?” (VID-SAMPLE-006 comments) — answered via BORDER-RESTRAINT exceptions (inputs, tables, focus, density). |
